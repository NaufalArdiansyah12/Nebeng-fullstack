...
class _PaymentMethodPageState extends State<PaymentMethodPage> {
  ...
  void _handlePayment() async {
    ...
    try {
      ...
      final result = await _payment_service_create(
          widget.trip.id,
          userId,
          createdBookingNumber,
          createdBookingId,
  ...
  // Small wrapper in case PaymentService API changes; keeps code readable
  Future<Map<String, dynamic>> _payment_service_create(
      String tripId,
      int userId,
