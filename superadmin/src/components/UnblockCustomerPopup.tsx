...
interface UnblockCustomerPopupProps {
  open: boolean;
...
const UnblockCustomerPopup = ({ open, onOpenChange, onConfirm, type }: UnblockCustomerPopupProps) => {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md p-0 border-0 overflow-hidden">
        <DialogTitle className="sr-only">
          {type === "confirm" ? "Konfirmasi Unblock Akun" : "Unblock Akun Berhasil"}
        </DialogTitle>
        {/* Top accent border */}
          ...
          {type === "confirm" ? (
            <>
              ...
              <h2 className="text-xl font-bold text-foreground mb-6">
                Apakah Anda Yakin Ingin<br />Membuka Blokir Akun Ini
              </h2>
...
export default UnblockCustomerPopup;