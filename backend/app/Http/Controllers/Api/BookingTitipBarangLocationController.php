...
class BookingTitipBarangLocationController extends Controller
{
    public function store(Request $request, $id)
    {
        ...
        // Log location update
        Log::info('booking_titip_barang.location.update', [
        ...
        if ($pickupLat && $pickupLng) {
            ...
            Log::info('booking_titip_barang.location.distance_check', [
                'booking_id' => $booking->id,
            ...
            if ($booking->status === 'menuju_penjemputan' && $dist <= 10) {
                ...
                Log::info('booking_titip_barang.status.auto_update', [
                    'booking_id' => $booking->id,
