...
class BookingMobilLocationController extends Controller
{
    public function store(Request $request, $id)
    {
        ...
        Log::info('booking_mobil.location.update', [
        ...
        if ($pickupLat && $pickupLng) {
            ...
            Log::info('booking_mobil.location.distance_check', [
                'booking_id' => $booking->id,
